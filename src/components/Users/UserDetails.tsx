...
const userSchema = z
  .object({
    ...
    password_confirmation: z.string().min(12, 'Password confirmation is required').max(200, 'Password confirmation cannot exceed 200 characters'),
    emp_code: z
      .string()
    ...
    <fieldset>
      <div className="form-grid" style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
        ...
        <div className="form-group">
          ...
          <select id="role" value={user.role || ''} onChange={(e) => validateAndSetField('role', e.target.value)}>
